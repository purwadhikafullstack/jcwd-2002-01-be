...
router.post("/selected-cart", AuthorizeLoggedInUser, cartController.getSelectedCart)
router.post("/checkout", AuthorizeLoggedInUser, cartController.checkoutCart)
router.get("/checkout-items", AuthorizeLoggedInUser, cartController.getCheckoutCart)
